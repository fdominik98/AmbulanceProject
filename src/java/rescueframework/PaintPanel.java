...
public class PaintPanel extends JPanel{  
    ...
    private Color indexedColors[] = new Color[20];
    ...
    public PaintPanel() {
        ...
        indexedColors[9] = new Color(34,139,34);
        indexedColors[10] = new Color(102, 0, 0);
        indexedColors[11] = new Color(153, 0, 0);
        indexedColors[12] = new Color(0, 77, 46);
        indexedColors[13] = new Color(0, 61, 102);
        indexedColors[14] = new Color(96, 64, 32);
        indexedColors[15] = new Color(68, 68, 34);
        indexedColors[16] = new Color(77, 51, 0);
        indexedColors[17] = new Color(61, 61, 41);
        indexedColors[18] = new Color(31, 47, 52);
        indexedColors[19] = new Color(110, 134, 103);
    ...
    public void paintComponent(Graphics g) {
        ...
        for (int i=0; i<map.getRobots().size(); i++) {
            Ambulance robot = map.getRobots().get(i);
            int x = robot.getLocation().getX();
            int y = robot.getLocation().getY();
            String image = "";
            if(robot.getSirenRed())
            	image = "ambulance1";
            else
            	image = "ambulance2";
            g2.drawImage(map.getCachedImage(image), x*cellSize+1, y*cellSize+1, cellSize-1, cellSize-1, null);
     ...
     */
    public void mouseClicked(int x, int y, javax.swing.JLabel coordLabel) {
        ...
        coordLabel.setText("("+cellX + ";" + cellY +")");
        // Move the first robot if there is one
        Cell c = RescueFramework.map.getCell(cellX, cellY);
        if (c != null && !c.hasObstacle()) {
        	Random random = new Random();
            int h =  random.nextInt(1000 - 500) + 500;
           Injured i = new Injured(h);
           c.setInjured(i);
           i.setLocation(c);
